...
const componentCategories = {
  Components: [
    ...
    'code-comparison', 'script-copy-btn', 'scroll-progress', 'lens', 'pointer'
  ],
...
async function fetchComponentsByCategory(
  ...
  for (const componentName of categoryComponents) {
    ...
    try {
      ...
      const relevantExampleNames = exampleNamesByComponent.get(componentName) || [];
...
async function registerCategoryTools() {
  ...
  for (const [category, categoryComponents] of Object.entries(componentCategories)) {
